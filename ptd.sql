CREATE TABLE `ptd_calendrier` (
  ...
  `pays` int NOT NULL DEFAULT '1',
  `motif` varchar(150) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;

--
-- Déchargement des données de la table `ptd_calendrier`
--
...
--
-- Structure de la table `ptd_categorie`
--
...
--
-- Déchargement des données de la table `ptd_categorie`
--
...
--
-- Structure de la table `ptd_clubs`
--
...
--
-- Déchargement des données de la table `ptd_clubs`
--
...
--
-- Structure de la table `ptd_creneau`
--
...
--
-- Déchargement des données de la table `ptd_creneau`
--
...
--
-- Structure de la table `ptd_equipe_engagee`
--
...
--
-- Déchargement des données de la table `ptd_equipe_engagee`
--
...
--
-- Structure de la table `ptd_match`
--
...
CREATE TABLE `ptd_match` (
  ...
  `categorie` int NOT NULL,
  `club_recevant` int NOT NULL,
  `creneau_choisi` int DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;

--
-- Déchargement des données de la table `ptd_match`
--
